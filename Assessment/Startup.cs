...
using Assessment.Services.Redis;
...
namespace Assessment
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DbAssessmentContext>(options =>
               options.UseSqlServer("Server = CARETTIN\\SQLEXPRESS;Database=PersonDb;Trusted_Connection=True;"));
